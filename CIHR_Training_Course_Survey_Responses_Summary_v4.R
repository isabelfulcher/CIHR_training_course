...
lecture1 <- read.xlsx("r/CIHR/CIHR Course/Survey Responses.xlsx", sheet = 1, startRow = 3)
lecture2 <- read.xlsx("r/CIHR/CIHR Course/Survey Responses.xlsx", sheet = 2, startRow = 3)
lecture3 <- read.xlsx("r/CIHR/CIHR Course/Survey Responses.xlsx", sheet = 3, startRow = 3)
lecture4 <- read.xlsx("r/CIHR/CIHR Course/Survey Responses.xlsx", sheet = 4, startRow = 3)
CourseEnd <- read.xlsx("r/CIHR/CIHR Course/Survey Responses.xlsx", sheet = 5, startRow = 3)
